                ...
                <div class="col-lg-4">
                    <div class="player-profile">
                        <div class="player-pic">
                            <img src="fotos_jogadores/<?php echo $fotografia; ?>" alt="<?php echo $nome; ?>">
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="posicao" name="posicao" required>
                                            ...
                                            <option value="Defesa" <?php if($posicao == "Defesa") echo "selected"; ?>>Defesa</option>
                                            <option value="Médio" <?php if($posicao == "Médio") echo "selected"; ?>>Médio</option>
                                            <option value="Avançado" <?php if($posicao == "Avançado") echo "selected"; ?>>Avançado</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="escalao" name="escalao" required>
                                            <option value="">Selecione...</option>
                                            <option value="Iniciados" <?php if($escalao == "Iniciados") echo "selected"; ?>>Iniciados</option>
                                            <option value="Juvenis" <?php if($escalao == "Juvenis") echo "selected"; ?>>Juvenis</option>
                                            <option value="Juniores" <?php if($escalao == "Juniores") echo "selected"; ?>>Juniores</option>
                                            <option value="Seniores" <?php if($escalao == "Seniores") echo "selected"; ?>>Seniores</option>
                                        </select>
                                    </div>
                                </div>
