        ...
        <ul class="main-menu mobile-menu">
               <li class="active"><a href="./home.php">Home</a></li>
                                <li><a href="./club.php">Clube</a></li>
                                 <li><a href="#" class="active">Atletas</a>
                                    <ul class="dropdown">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6" style="text-align: right;">
                        <div class="">
                            <p><a href="logout.php" class="primary-btn">LogOut</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="header__nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="./home.php"><img src="imagens/ClubeMaster_pequeno.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-10">
                        <div class="nav-menu">
                            <ul class="main-menu">
                                ...
                                <li><a href="./club.php">Clube</a></li>
                                 <li class="active"><a href="#">Atletas</a>
                                    <ul class="dropdown">
                                            <li><a href="./perfil.php">Perfil</a></li>
                                            <li><a href="./blog-details.php">Ficha Clínica</a></li>
                                            <li><a href="#">Upload de Documentos</a></li>
