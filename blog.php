...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="header__top--canvas">
            ...
            <div class="ht-links">
                <a href="contaclube.php" class="primary-btn">Definições</a>
            </div>
            <div class="ht-links">
        ...
        <ul class="main-menu mobile-menu">
               <li class="active"><a href="./home.php">Home</a></li>
                                <li><a href="./club.php">Clube</a></li>
                                 <li><a href="./atletas.php">Atletas</a>
                                    <ul class="dropdown">
                                            <li><a href="./perfil.php">Perfil</a></li>
                                            <li><a href="./blog-details.php">Ficha Clínica</a></li>
                                            <li><a href="#">Upload de Documentos</a></li>
                                            <li><a href="#">Histórico</a></li>
                                    </ul>
                                </li> 
                                <li><a href="#">Treinos</a>
                                    <ul class="dropdown">
                                        <li><a href="./blog.php">Calendário</a></li>
                                        <li><a href="./blog-details.php">Convocatórias</a></li>
                                        <li><a href="#">Folhas de Presenças</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6" style="text-align: right;">
                        <div class="">
                            <p>
                            <a href="definicoes.php" class="primary-btn" style="padding: 5px 10px; font-size: 12px;">Definições da conta</a> <a href="logout.php" class="primary-btn" style="padding: 5px 10px; font-size: 12px;">Logout</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 left-blog-pad">
                    <div class="large-blog set-bg" data-setbg="img/blog/blog-1.jpg">
                        ...
                        <div class="bi-text">
                            <h3><a href="./blog-details.php">England Women 1-0 Argentina Women: Taylor guarantees Lionesses' path to last
                                    16</a></h3>
                            <ul>
                    ...
                    <div class="blog-items">
                        <div class="single-item">
                            ...
                            <div class="bi-text">
                                <h4><a href="./blog-details.php">Jodie Taylor celebrates her first goal of the tournament</a></h4>
                                <ul>
                                    <li><i class="fa fa-calendar"></i> May 19, 2019</li>
                                    <li><i class="fa fa-edit"></i> 3 Comment</li>
                                </ul>
                        ...
                        <div class="single-item">
                            ...
                            <div class="bi-text">
                                <h4><a href="./blog-details.php">Vanina Correa keeps out Nikita Parris' first-half penalty</a></h4>
                                <ul>
                                    <li><i class="fa fa-calendar"></i> May 19, 2019</li>
                                    <li><i class="fa fa-edit"></i> 3 Comment</li>
                                </ul>
                        ...
                        <div class="single-item">
                            ...
                            <div class="bi-text">
                                <h4><a href="./blog-details.php">Derby will demand £4m for Lampard next year</a></h4>
                                <ul>
                                    <li><i class="fa fa-calendar"></i> May 19, 2019</li>
                                    <li><i class="fa fa-edit"></i> 3 Comment</li>
                                </ul>
                        ...
                        <div class="single-item">
                            ...
                            <div class="bi-text">
                                <h4><a href="./blog-details.php">Virgil van Dijk says Liverpool are hungry for more success</a></h4>
                                <ul>
                                    <li><i class="fa fa-calendar"></i> May 19, 2019</li>
                                    <li><i class="fa fa-edit"></i> 3 Comment</li>
                                </ul>
